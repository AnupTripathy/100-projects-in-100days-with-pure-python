...
interpret_bmi = ""
if bmi < 18:
    interpret_bmi = "underweight"

elif bmi > 18 and bmi <= 25:
    interpret_bmi = "normal weight"

elif bmi > 25 and bmi <= 30:
    interpret_bmi = "slightly overweight"

elif bmi > 30 and bmi <= 35:
    interpret_bmi = "underweight"

else:
    interpret_bmi = "clinically obese"
print(f"Your BMI is {round(bmi)}, you are {interpret_bmi}.")
